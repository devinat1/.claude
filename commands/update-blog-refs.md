...
Read every file in `/Users/devinat1/Desktop/blog/content/` except `index.md` and the `images/` directory. For each post, note its title (filename without `.md`) and core topic.

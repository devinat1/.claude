...
**Files:**
- Create: `~/.claude/projects/-Users-devinat1--claude/memory/skills_tracker.md`
...
Run: `cat ~/.claude/projects/-Users-devinat1--claude/memory/skills_tracker.md`
...
**Files:**
- Create: `~/.claude/projects/-Users-devinat1--claude/memory/MEMORY.md`
...
Run: `cat ~/.claude/projects/-Users-devinat1--claude/memory/MEMORY.md`
...
**Files:**
- Modify: `~/.claude/CLAUDE.md` (append after existing content)

- [ ] **Step 1: Read the current CLAUDE.md**

Read `~/.claude/CLAUDE.md` to confirm current contents end with the Thinking Check section.
...
Read `~/.claude/CLAUDE.md` and confirm the Skills Tracker section appears after the Thinking Check section, with no corruption of existing content.
...
**Files:**
- Create: `~/.claude/commands/experience.md`
...
Run: `cat ~/.claude/commands/experience.md`
...
Run: `head -4 ~/.claude/commands/experience.md`
Expected:
```
---
name: experience
...
Run: `ls -la ~/.claude/commands/experience.md ~/.claude/projects/-Users-devinat1--claude/memory/skills_tracker.md ~/.claude/projects/-Users-devinat1--claude/memory/MEMORY.md ~/.claude/CLAUDE.md`
Expected: All four files listed with non-zero sizes.

- [ ] **Step 2: Verify CLAUDE.md has both sections**

Read `~/.claude/CLAUDE.md` and confirm it contains:
...
Run: `head -5 ~/.claude/projects/-Users-devinat1--claude/memory/skills_tracker.md`

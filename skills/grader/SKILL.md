...
1. **Read the skills tracker** at `/Users/devinat1/.claude/projects/-Users-devinat1--claude/memory/skills_tracker.md`. If missing/empty, create it with frontmatter (`name: skills-tracker`, `type: user`) and sections `## Current Blind Spots`, `## Skills`, `## Resolved Blind Spots`.
